...
const fromEmail = process.env.FROM_EMAIL || "noreply@stablebricks.com"
...
export async function sendContactNotificationEmail(contactData: ContactData) {
  ...
  await sendMail({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>You have received a new contact form submission from the Commodex website:</p>
