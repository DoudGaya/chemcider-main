        ...
        <section className=" flex flex-col ">
            <div className="grid grid-cols-2 gap-6">
                <div className=" my-10 py-10 space-y-8 ">
                    ...
                    <a href="" className=' py-4 px-6 bg-[rgb(34,176,196)] dark:hover:bg-[rgb(34,176,196)] text-white font-semibold dark:bg-purple-50/30 rounded-md flex space-x-3 items-center'>
