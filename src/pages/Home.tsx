...
const Details = ({ items }:any) => {
  return (
    <>
       <details className='flex w-full dark:open:bg-black open:bg-slate-50 space-y-4 open:shadow-lg open:backdrop-blur-md p-6 open:rounded-lg'>
...
function Home() {
  ...
  <div className=" grid md:grid-cols-2  grid-cols-1 md:gap-x-6 md:gap-y-0  mx-auto">
      ...
      <div className="dark:text-slate-100">
        <h2 className=' text-2xl text-center font-semibold '>Your Ultimate Destination for Scientific and Engineering Solutions</h2>
